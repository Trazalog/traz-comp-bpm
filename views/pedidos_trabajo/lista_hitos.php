        ...
        <?php
            foreach ($hitos as $key => $o) {
                ...
                echo '<td><div class="btn-group">
                        <button onclick="reload(\'#tareas_planificadas\','.$o->hito_id.$info_id.$petr_id.');" type="button" class="btn code"><h4>'.$o->numero.'</h4><img src="http://localhost/traz-tools/lib/dist/img/user2-160x160.jpg" class="user-image" alt="User Image" data-user="'.$o->user_id.'"></button>
