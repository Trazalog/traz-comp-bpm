...
if (!function_exists('timelineInfoActual')) {
    function timelineInfoActual($timeline)
    {
        ...
        echo '<div class="panel panel-primary">
                ...
                <div class="panel-body" style="max-height: 500px;overflow-y: scroll;">
                <div class="container" ><ul class="timeline">';
        echo '<h2 style="margin-left:50px;">Estado Actual:</h2>';
        echo '<li class="time-label"><span class="bg-red"><i class="glyphicon glyphicon-time"></i>  '.$fecha_actual.'</span></li>';
        foreach ($timeline['listAct'] as $f) {
            echo '<li class="time-label">
                            <div class="timeline-badge info"><i class="fa fa-bell blue"></i></div>
                            <div class="timeline-panel">
                                    <div class="timeline-heading">
                                    <h4 class="timeline-title">' . $f['displayName'] . '</h4>
                                    <p><small class="text-muted"><i class="glyphicon glyphicon-time"></i> Fecha Inicio: ' . date_format(date_create($f['reached_state_date']), 'd-m-Y H:i') . ' hs </small></p>
